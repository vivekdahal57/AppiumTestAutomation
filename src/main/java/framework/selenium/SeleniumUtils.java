...
public class SeleniumUtils {
    ...
    public static void hoverOnElement(WebElement element, AppiumDriver<MobileElement> driver) {
        if (isIPhone(driver)) {
    ...
    public static void scrollAndClick(AppiumDriver<MobileElement> driver, MobileElement element) {
        Actions actions = new Actions(driver);
    ...
    public static void closeChildWindowAndGoBackToMainWindow(AppiumDriver<MobileElement> driver, boolean closeChildWindow) {
        ...
        try {
            WaitUtils.waitUntil(driver, TimeOuts.TEN_SECONDS, new Function<WebDriver, Boolean>() {
                @Override
    ...
    public static boolean isIPhone(AppiumDriver<MobileElement> driver) {
        return getDevice(driver) == IDriverConfiguration.Device.IPHONE;
    }

    public static IDriverConfiguration.Device getDevice(AppiumDriver<MobileElement> driver) {
        Capabilities caps = driver.getCapabilities();

        switch (caps.getBrowserName()) {
            case "ios":
                return IDriverConfiguration.Device.IPHONE;
            case "android":
                return IDriverConfiguration.Device.ANDROID;
            case "firefoxos":
                return IDriverConfiguration.Device.FIREFOX_OS;
            case "windows":
                return IDriverConfiguration.Device.WINDOWS;
            default:
                throw new RuntimeException("Unknown device " + caps.getBrowserName());
        }
